        ...
        <div>
            <div className="flex flex-col md:flex-row items-center justify-center">
                <div className="text-center md:text-start flex-1 order-3 md:order-1 ">
                    ...
                    <div className='md:content-center px-6 md:px-40 py-6 md:py-72 md:bg-image-left-error md:bg-contain md:bg-fixed md:bg-no-repeat'>
                ...
                <div className="flex justify-center flex-1 animate-upDown order-1 md:order-3">
                    <Image src={images.image404} alt="Broken" width={500} height={400} className='w-[272px] md:w-[500px]'/>
                </div>
            </div>
        </div>
    );
