...
export default function FoundGallery() {
    ...
    return (
        <div className="flex flex-col lg:flex-row lg:py-9 lg:px-20 2xl:px-36 ">
            ...
            <GalleryCategory uploadState={uploadState} setUploadState={setUploadState} setSelectedUpload={setSelectedUpload} />

            {/* Right Section - Gallery Item */}
            <GalleryItem uploadState={uploadState} setUploadState={setUploadState} setSelectedUpload={setSelectedUpload} selectedUpload={selectedUpload} />
        </div>
    );
}