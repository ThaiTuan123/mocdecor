class Languages {
    strings: any = {
        vn: {
            ...
            '404errorTitle': 'UI!!! Đã có lỗi gì đó...',
            '404errorMessage': 'Trang bạn đang tìm kiếm bị lỗi và hiện không thể truy cập, team Mộc đang cố gắng khắc phục sự cố này. Trong lúc chờ, bạn có thể trở lại trang chủ để khám phá những nội dung thú vị khác từ Mộc nha.',
            '404returnHome': 'Trở về trang chủ',
        }
    }
