class Languages {
    strings: any = {
        vn: {
            ...
            'payment.desc': 'Khám phá các chính sách mua hàng, bảo hành và đổi trả của MỘC Decor để yên tâm khi chọn mua sản phẩm khung ảnh thủ công chất lượng',
            ...
            'payment.info.input.address.placeholder': 'Nhập địa chỉ cụ thể. Số nhà, tên đường...',
