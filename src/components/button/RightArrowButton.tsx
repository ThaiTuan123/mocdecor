...
const RightArrowButton: React.FC<RightArrowButtonProps> = ({ onClick }) => {
    return (
        <div
            onClick={onClick}
            className="hidden md:flex flex-col justify-center items-center bg-white w-14 h-8 rounded transition-all duration-500 ease-in-out cursor-pointer group hover:bg-brown-200"
        >
