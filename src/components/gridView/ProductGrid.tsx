...
const ProductGrid: React.FC<{ category: string; subCategory: string }> = ({
  ...
  const [selectedProduct, setSelectedProduct] = useRecoilState<Product | null>(
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3 md:gap-6 lg:grid-cols-4">
        {showViewMoreButton ? (
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-4">
            <p className="text-xl">
              Chúng tôi đang trong quá trình cập nhật sản phẩm {subCategory}.
              Nếu cần, có thể liên hệ trực tiếp với chúng tôi.
            </p>
          </div>
        )}
      </div>
