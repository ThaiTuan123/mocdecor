...
const BackgroundSection: React.FC<BackgroundSectionProps> = ({title, subTitle, backgroundClass,backgroundMobileClass}) => (
    <section
        className={`2xl:container 2xl:mx-auto bg-cover bg-no-repeat bg-center h-252 md:h-327 lg:max-h-430 lg:h-430 ${backgroundMobileClass} md:${backgroundClass} flex items-center justify-start px-6 lg:pl-36`}>
