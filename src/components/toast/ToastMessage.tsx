...
const ToastMessage: React.FC<ToastProps> = ({
  ...
  return (
    <div className="animate-slide-in fixed bottom-5 left-5 z-50 flex transform items-center gap-3 rounded-lg bg-green-500 p-4 text-white shadow-lg transition-transform">
