...
const FooterDiscover = () => {
    ...
    return (
        <div className="px-6 md:px-0 bg-image-footer-policy bg-no-repeat bg-cover flex items-center flex-col pb-14 pt-24 text-white">
            ...
            <div className="w-52 h-12 flex items-center justify-center border-primary border-solid border-2 cursor-pointer mb-6 md:mb-8 bg-white rounded hover:scale-105">
