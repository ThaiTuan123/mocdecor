...
const useProductCategories = (name: string): { productCategories: CategoryType[]; loading: boolean } => {
    const [productCategories, setProductCategories] = useRecoilState(categoriesState);
